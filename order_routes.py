...
from utils.email_helper import send_email   # <-- using centralized email helper

order_bp = Blueprint("order", __name__)


# -----------------------------------------------------
# CREATE ORDER (CHECKOUT WITH CUSTOMER DETAILS)
# -----------------------------------------------------
@order_bp.post("/checkout")
def checkout():
    data = request.json or {}

    # SAFE ACCESS – NO CRASH EVEN IF KEYS ARE MISSING
